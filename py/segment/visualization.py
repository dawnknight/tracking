...
ptstrj = loadmat('./mat/sparse_ptsTrj.mat')
...
mask = loadmat('./mat/finalresult')['mask'][0]
#mask = mask -1  # modify index from matlab to python                                                                   
labels = loadmat('./mat/finalresult')['label'][0]
...
while (frame_idx <fnum):
    ...
    name = '/home/andyc/image/AIG/part2all/'+str(frame_idx).zfill(4)+'.jpg'
    savefig(name)
